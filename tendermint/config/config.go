...
type P2PConfig struct { //nolint: maligned
	...
	TestIntercept bool `mapstructure:"test-intercept"`

	ControllerMasterAddr string `mapstructure:"controller-master-addr"`
	ControllerListenAddr string `mapstructure:"controller-listen-addr"`
	ControllerExternAddr string `mapstructure:"controller-extern-addr"`
}
...
func DefaultP2PConfig() *P2PConfig {
	return &P2PConfig{
		...
		TestDialFail:            false,
		TestIntercept:           false,
		ControllerMasterAddr:    "127.0.0.1:8080",
		ControllerListenAddr:    "127.0.0.1:8081",
		ControllerExternAddr:    "",
	}
}
...
type ConsensusConfig struct {
	...
	TimeoutAsMessage bool `mapstructure:"timeout-as-message`
