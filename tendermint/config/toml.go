...
test-intercept = "{{ .P2P.TestIntercept }}"
controller-extern-addr = "{{ .P2P.ControllerExternAddr }}"
controller-listen-addr = "{{ .P2P.ControllerListenAddr }}"
controller-master-addr = "{{ .P2P.ControllerMasterAddr }}"
