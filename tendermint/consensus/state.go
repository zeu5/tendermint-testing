...
func (ti *timeoutInfo) String() string {
	return fmt.Sprintf("%v ; %d/%d %v", ti.TimeDuration, ti.Height, ti.Round, ti.Step)
}

func (ti timeoutInfo) Duration() time.Duration {
	return ti.TimeDuration
}

func (ti timeoutInfo) Key() string {
...
// func TickerOption(asMessage bool) StateOption {
// 	return func(cs *State) {
// 		if asMessage {
// 			cs.timeoutTicker = NewControlledTimeoutTicker()
// 		}
// 	}
// }
...
func (cs *State) handleTimeout(ti timeoutInfo, rs cstypes.RoundState) {
	cs.Logger.Debug("received tock", "timeout", ti.TimeDuration, "height", ti.Height, "round", ti.Round, "step", ti.Step)
...
func (cs *State) finalizeCommit(height int64) {
	...
	if er == nil {
		c.PublishEventAsync("Committing block", map[string]string{
...
func (cs *State) defaultSetProposal(proposal *types.Proposal) error {
	cs.Logger.Info("received proposal and yet to check", "proposal", proposal)
	// Already have one
...
func (cs *State) addVote(vote *types.Vote, peerID p2p.NodeID) (added bool, err error) {
	cs.Logger.Debug(
		...
		"cs_height", cs.Height,
		"block_id", string(vote.BlockID.Hash),
...
func (cs *State) signVote(
	...
	v := vote.ToProto()
	cs.Logger.Info("Signing vote", "pubkey-addr", addr)
