...
import (
	...
	"github.com/tendermint/tendermint/abci/example/validator"
...
var RootCmd = &cobra.Command{
	...
	PersistentPreRunE: func(cmd *cobra.Command, args []string) error {
		...
		switch cmd.Use {
		case "counter", "kvstore", "validator": // for the examples apps, don't pre-run
			return nil
...
var validatorCmd = &cobra.Command{
	Use:   "validator",
	Short: "ABCI demo validator app",
	Long:  "ABCI demo validator app",
	Args:  cobra.ExactArgs(0),
	RunE:  cmdValidator,
}
...
func cmdValidator(cmd *cobra.Command, args []string) error {
	logger := log.NewTMLogger(log.NewSyncWriter(os.Stdout))

	// Create the application - in memory or persisted to disk
	app := validator.NewApplication()
