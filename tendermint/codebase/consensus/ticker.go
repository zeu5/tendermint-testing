...
func (t *timeoutTicker) timeoutRoutine() {
	...
	for {
		...
		case newti := <-t.tickChan:
			...
			ti = newti
			t.timer.Reset(ti.TimeDuration)
			t.Logger.Debug("Scheduled timeout", "dur", ti.TimeDuration, "height", ti.Height, "round", ti.Round, "step", ti.Step)
		case <-t.timer.C:
			t.Logger.Info("Timed out", "dur", ti.TimeDuration, "height", ti.Height, "round", ti.Round, "step", ti.Step)
